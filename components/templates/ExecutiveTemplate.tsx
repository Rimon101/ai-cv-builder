    ...
    >
      <header className="border-b pb-4">
        <div className="flex items-start justify-between gap-6">
          <div>
            <p className="text-xs uppercase tracking-[0.2em] text-slate-500">Executive Profile</p>
        ...
        <section className="mt-6">
          ...
          <div className="mt-3 space-y-4">
            {data.experience.map((item) => (
              <div key={item.id} className="border-l-2 pl-4" style={{ borderColor: data.accentColor }}>
      ...
      <section className="mt-6 grid grid-cols-2 gap-6">
        ...
        {(data.skills.length > 0 || data.languages.filter((l) => l.language.trim()).length > 0) && (
          <div>
